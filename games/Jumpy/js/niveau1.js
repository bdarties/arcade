...
export default class niveau1 extends Phaser.Scene {
  ...
  preload() {
   ...
   this.load.image("plateform", "./assets/platformb.png");
    ...
    this.load.image("plateformm", "./assets/chainegrotte.png");
    this.load.image("plateformg", "./assets/tuyaugrotte.png");
  ...
  create() {
    ...
    this.skinsPlateformes = [/*"plateform", "plateform2", "plateform3"*/, "plateformp", "plateformm", "plateformg", "plateformb", "plateformea"];
...
this.skinFrequencies = {
  plateformp: 5,   // plateformes cassantes (peu fréquentes)
  plateformg: 2,  // tuyaux (exemple)
  plateformb: 2,  // roue
  plateformm: 2,  // chaine
  plateformea: 1  // champi rebondissant (peu fréquent)
};
