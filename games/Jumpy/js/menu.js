export default class menu extends Phaser.Scene {
  ...
  create() {
    ...
    var bouton_play = this.add.image(440, 350, "imageBoutonPlay").setDepth(1);  
    var bouton_2joueur = this.add.image(440, 450, "imageBouton2Joueurs").setDepth(1);
    var bouton_commandes = this.add.image(440, 550, "imageBoutonCommandes").setDepth(1);
    var bouton_credits = this.add.image(440, 650, "imageBoutonCredits").setDepth(1);
    ...
    this.actions = [
      () => this.scene.start("niveau1"),     // bouton 0 : play
      () => this.scene.start("niveau3"),     // bouton 1 : 2 joueurs
