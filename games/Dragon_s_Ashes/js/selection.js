...
/***********************************************************************/
  ...
  preload() {
    ...
    this.load.image("background01", "./assets/background1.png");
    this.load.image("background02", "./assets/background2.png");
...
// chargement du jeu de tuiles
 const tilesetBackground01 = carteDuNiveau.addTilesetImage("background01", "background01");
const tilesetBackground02 = carteDuNiveau.addTilesetImage("background02", "background02");
const tilesetDecors      = carteDuNiveau.addTilesetImage("Tuiles_Decors01", "Tuiles_Decors01");

const calque_background01  = carteDuNiveau.createLayer("calque_background01", tilesetBackground01);
const calque_background02 = carteDuNiveau.createLayer("calque_background02", tilesetBackground02);
const calque_decors      = carteDuNiveau.createLayer("calque_decors", tilesetDecors);
...
this.objetSaut = this.physics.add.staticSprite(900, 900, "img_jumpBonus");
...
this.popupTexteSaut = this.add.text(
    this.cameras.main.width / 2,
    this.cameras.main.height / 2,
    "Vos aventures vous ont endurcis, vous êtes enfin prêt à vous venger !\n\nVous pouvez maintenant voler en appuyant plusieurs fois sur P. \n\nAppuyez sur K pour fermer la fenêtre.\n",
    {
        fontSize: "20px",
        fill: "#ffffff",
        align: "center",
...
this.objetInteractif = this.physics.add.staticSprite(500, 930, "img_chest1");
...
this.physics.add.collider(this.boss, calque_decors);
...
this.physics.add.overlap(this.groupeAttaques, this.groupeEnnemis, (hitbox, ennemi) => {
    ...
    this.physics.add.collider(player, calque_decors); 
    this.physics.world.setBounds(0, 0, 3200, 3648);
    //  ajout du champs de la caméra de taille identique à celle du monde
    this.cameras.main.setBounds(0, 0, 3200, 3648);
