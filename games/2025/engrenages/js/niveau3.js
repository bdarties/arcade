...
export default class niveau3 extends Phaser.Scene {
  ...
  create(data) {
    ...
    // Musique du niveau 1 : arrêter la musique globale si nécessaire et jouer la piste level1_music
    // La musique est maintenant gérée par le MusicManager
  ...
  this.clavier1.action = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.I); // Touche I pour action J1
    ...
    // Création du J2
    this.player2 = this.physics.add.sprite(1568, 5620, "img_perso2");
  ...
  this.player2.targetVel = 0;
    ...
    // *** AJOUTEZ CETTE LIGNE ICI ***
  // On définit la touche pour le terminal une seule fois à la création de la scène
  ...
  platform.body.setGravityY(0);
    ...
    const feuTargetY = 3340;
      ...
      this.physics.add.overlap(this.player2, this.feu, () => {
        // La musique sera automatiquement redémarrée par le MusicManager lors du restart
