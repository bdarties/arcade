export default class Player extends Phaser.Physics.Arcade.Sprite {
  constructor(scene, x, y) {
    ...
    this.vitesseBalles = this.statsDeBase.vitesseBalles;
  ...
  tirer(ennemi) {
    ...
    let vitesse = this.vitesseBalles;
    ...
    // jouer le son du tir du joueur (une fois)
    if (this.scene && this.scene.sound && this.scene.sound.play) {
      this.scene.sound.play('gunshot', { volume: 0.25, loop: false });
    }
  }
