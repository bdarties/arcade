...
export default class niveau3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.keyJump = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.O); // Saut avec O
    ...
    update() {
        ...
        if (this.keyK && Phaser.Input.Keyboard.JustDown(this.keyK)) {
            try { if (this.music) this.music.stop(); } catch(e) { console.warn('Erreur en stoppant la musique:', e); }
