...
export default class IntroVideo3 extends Phaser.Scene {
    constructor() {
        super({ key: 'introvideo3' });
    }

    preload() {
        this.load.video('video3', 'assets/video/video3.MP4', 'loadeddata', true, false);
    ...
    create() {
        ...
        const video = this.add.video(this.game.config.width / 2, this.game.config.height / 2, 'video3');
        // Activer le son
        video.setMute(false);
