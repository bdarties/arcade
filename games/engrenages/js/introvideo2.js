...
export default class IntroVideo2 extends Phaser.Scene {
    constructor() {
        super({ key: 'introvideo2' });
    }

    preload() {
        this.load.video('video2', 'assets/video/video2.mp4', 'loadeddata', true, false);
    ...
    create() {
        ...
        const video = this.add.video(this.game.config.width / 2, this.game.config.height / 2, 'video2');
        // Activer le son
        video.setMute(false);
        ...
        // Quand la vidéo est finie, lancer le niveau suivant
        video.on('complete', () => {
