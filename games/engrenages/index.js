...
import choixmode from "./js/choixmode.js";  // Choix du mode de jeu
import introvideo1 from "./js/introvideo1.js"; // Vidéo d'intro niveau 3
import introvideo2 from "./js/introvideo2.js"; // Vidéo avant niveau 2
import introvideo3 from "./js/introvideo3.js"; // Vidéo avant niveau 1
import introvideo4 from "./js/introvideo4.js"; // Vidéo de fin
...
import niveau1_speedrun from "./js/niveau1_speedrun.js";      // Niveau 1 speedrun
import niveau2_speedrun from "./js/niveau2_speedrun.js";      // Niveau 2 speedrun
import niveau3_speedrun from "./js/niveau3_speedrun.js";      // Niveau 3 speedrun
...
var config = {
  ...
  physics: {
    ...
    arcade: {
      ...
      debug: false // Affichage du debug physique
    }
  },
  scene: [
    ...
    introvideo1,  // Vidéo d'intro niveau 3
    introvideo2,  // Vidéo avant niveau 2
    introvideo3,  // Vidéo avant niveau 1
    introvideo4,  // Vidéo de fin
    niveau1,      // Niveau 1
    niveau1_speedrun, // Niveau 1 en mode speedrun
    niveau2,      // Niveau 2
    niveau2_speedrun, // Niveau 2 en mode speedrun
    niveau3,      // Niveau 3
    niveau3_speedrun, // Niveau 3 en mode speedrun
    ...
    credits,       // Crédits
    pause,       // Pause
    musicManager   // Gestionnaire de musique
  ],
};
