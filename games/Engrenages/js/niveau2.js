...
//spritesheets ennemis 2
  ...
  this.player2.targetVel = 0;
    ...
    // Porte de sortie (récupération depuis le calque 'terminal' si présent)
  ...
  update() {
    ...
    const releaseLerp = 0.12; // quand on relâche, donne une courbe/décélération douce
    ...
    const releaseLerp2 = 0.10; // un peu plus doux pour la caméra du joueur 2
